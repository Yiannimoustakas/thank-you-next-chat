     ...
     <Layout pageTitle="Realtime Chat">
       ...
       <main className="container-fluid position-absolute h-100 bg-secondary">
         ...
         <div className="row position-absolute w-100 h-100">
           ...
           <section className="col-md-4 position-relative d-flex flex-wrap h-100 align-items-start align-content-between bg-primary px-0">{ user && <Chat activeUser={user} /> }</section>
