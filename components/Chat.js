...
class Chat extends Component {
  ...
  render() {
    return (this.props.activeUser && <Fragment>
      ...
      <div className="border-bottom border-gray w-100 d-flex align-items-center bg-primary" style={{ height: 90 }}>
        <h2 className="text-light mb-0 mx-4 px-2">{this.props.activeUser}</h2>
      </div>
      ...
      <div className="border-top border-gray w-100 px-4 d-flex align-items-center bg-primary" style={{ minHeight: 90 }}>
